...
public class MD5Util {
     ...
     * 已经在系统内占用了一个句柄， 而使用 FileChannel.close 方法是无法释放这个句柄的，且FileChannel有没有提供类似 unmap 的方法， 因此会出现无法删除文件的情况。
     * 
     * 不推荐使用
     * 
     * @param file
    ...
    public static void main(String[] args) {
        try {
            ...
            File big = new File("D:/opt/call/20120730/100126418651.wav");
