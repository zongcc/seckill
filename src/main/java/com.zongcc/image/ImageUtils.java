...
public class ImageUtils {
     ...
     */
    public final static void addImageWeatermark(String targetImg, String waterImg, int x, int y, float alpha)throws
            IOException {
        try {
    ...
    public static void resize(String filePath, int height, int width, boolean bb) {
        try {
            ...
            if (bb) {
                ...
                Point2D p2 = new Point(width,height);
                //GradientPaint gradientPaint =new GradientPaint(0f, 0f,Color.yellow, width, height,Color.blue);
                //GradientPaint gradientPaint =new GradientPaint(p1,Color.yellow, p2,Color.blue);
                //g.setPaint(gradientPaint);
                g.fillRect(0, 0, width, height);
                if (width == itemp.getWidth(null))
                    g.drawImage(itemp, 0, 0, itemp.getWidth(null),
    ...
    public static void mergeImage(String oneSrc, String twoSrc, String mergeSrc) {
        ...
        try {
            ...
            // 生成新图片
            BufferedImage imageNew = new BufferedImage((int)(width * 1.5), height, BufferedImage.TYPE_INT_RGB);
            imageNew.setRGB(0, 0, width, height, imageArrayOne, 0, width); // 设置左半部分的RGB
            imageNew.setRGB((int)0.5*width, 0, width, height, imageArrayTwo, 0, width); // 设置右半部分的RGB
    ...
    public static void main(String[] args) throws Exception{
            //ImageUtils.mergeImage("D:/1.jpg", "D:/2.jpg", "D:/3.jpg");
        //**测试添加图片水印*//*
            //ImageUtils.addImageWeatermark("D:/1.jpg", "D:/2.jpg", 100, 0, 0.5f);
        //**测试添加文字水印*//*
            //ImageUtils.addTextWeatermark("D:/1.jpg", "添加文本水印", "宋体", Font.BOLD | Font.ITALIC, 20, Color.BLACK,10, 10,8f);
        //**图片缩放*//*
            ImageUtils.resize("D:/1.jpg", 138, 212, true);
    }
}
